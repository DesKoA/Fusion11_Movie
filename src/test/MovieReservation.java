...
//					"영화로운 나날 (영어자막)" };
			String[] strings = MovieDBManager.movie_selectAllName(true);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(MovieReservation.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
