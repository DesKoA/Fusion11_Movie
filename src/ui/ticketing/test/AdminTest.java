...
public class AdminTest extends JFrame {
	...
	public void showTableDB() {
		String[] header = { "제목", "극장", "일자", "시작", "종료"};
		// select movie_title, screen_name, movie_date, movie_start, movie_end from movie_theaters where screen_name = '1관' and TO_CHAR(movie_date, 'YYYYMMDD')='20200124' order by screen_name, movie_start asc;
	...
	public void initComponents() {
		...
		movieTimeLabel.setFont(new Font("나눔스퀘어", 0, 18)); // NOI18N
		...
		movieTimeLabelName.setFont(new Font("나눔스퀘어", 0, 18)); // NOI18N
        ...
        lblNewLabel.setFont(new Font("나눔바른고딕", Font.PLAIN, 13));
        ...
        inTxtLb.setFont(new Font("나눔바른고딕", Font.PLAIN, 14));
